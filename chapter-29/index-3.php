...
// Виртуальные массивы
/**
 * Класс представляет собой массив, ключи которого нечувствительны к регистру символов.
 * Например, ключи "key", "kEy" и "KEY" с точки зрения данного класса выглядят идентичными (в отличие от стандартных массивом PHP,
...
$a->log("## Получаем значение оператора (оператор []).");
