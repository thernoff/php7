 ...
 class DirPager extends Pager
 {
     ...
     public function getItemsCount()
     {
         ...
         if (($dir = opendir($this->dirname)) !== false) {
             ...
             echo "Can't open dir " . $this->dirname;
         }
     ...
     public function getItems()
     {
         ...
         // Проверяем, попадает ли запрашиваемый номер страницы в интервал
         ...
         while (($file = readdir($dir)) !== false) {
             ...
             if (is_file($this->dirname . "/" . $file)) {
                 ...
                 // Помещаем пути файлов в массив, который будет возвращен методом
