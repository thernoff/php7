...
class PHP_Exceptionizer_Catcher
{
  ...
  public function handler($errno, $errstr, $errfile, $errline)
  {
    ...
    if (!($errno & $this->mask)) { // Если $errno (код ошибки) не входит в маску, то входим в блок условия
    ...
    foreach ($types as $t) {
      $e = constant($t); // $e может принимать следующие значения: 1, 2, 4, 8, 16, ..., 2048
      if ($errno & $e) { // $errno & $e если одинаковые, то будет то же самое, иначе 0: 1 & 2 = 0, 2 & 2 = 2, 2 & 4 = 0,...
        $className = $t;
        break;
      }
    }
