 ...
 * Гарантированно вызывает ob_end_clean() при выходе объекта класса за текущую область видимости.
 */
...
class Output
{
    ...
    public function __toString()
    {
        ...
        /**
         * Если текущий объект не является активным, то возвращается текст из внутреннего хранилища,
         * а иначе результат работы ob_get_contents()
         */
